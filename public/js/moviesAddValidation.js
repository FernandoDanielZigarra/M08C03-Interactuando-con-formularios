...
//-------------------DE REGISTRO DE PELÍCULAS------------------//     
    ...
    inputtitulo.addEventListener('blur', function(event){
        if(!event.target.value){
            ...
            document.querySelector(".error-title").innerHTML = "tiene que ingresar un titulo"
        }else{
    ...
    inputrating.addEventListener('blur', function(event){
        if(!event.target.value){
            ...
            document.querySelector(".error-rating").innerHTML = "tiene que ingresar un rating"
        }else if((event.target.value > 10 || event.target.value < 0)){
            inputrating.classList.add("is-invalid")
            document.querySelector(".error-rating").classList.add("is-invalid")
            document.querySelector(".error-rating").innerHTML = "el rating tiene que estar entre 1 y 10"
        }else{
    ...
    inputawards.addEventListener('blur', function(event){
        if(!event.target.value ){
            ...
            document.querySelector(".error-awards").innerHTML = "tiene que ingresar un valor de awards"
        }else if((event.target.value > 10 || event.target.value < 0)){
            inputawards.classList.add("is-invalid")
            document.querySelector(".error-awards").classList.add("is-invalid")
            document.querySelector(".error-awards").innerHTML = "los awards tienen que estar entre 1 y 10"
        }else{
    ...
    inputrelease_date.addEventListener('blur', function(event){
        if(!event.target.value){
            ...
            document.querySelector(".error-release_date").innerHTML = "tiene que ingresar una fecha"
        }else{
    ...
    inputlength.addEventListener('blur', function(event){
        if(!event.target.value){
            ...
            document.querySelector(".error-length").innerHTML = "tiene que ingresar un valor de duracion"
    ...
    inputgenre_id.addEventListener('blur', function(event){
        if(!event.target.value){
            ...
            document.querySelector(".error-genre").innerHTML = "tiene que ingresar un valor de genero"
        }else{
